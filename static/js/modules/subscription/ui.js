        ...
        function buildSubscriptionTaskIntro(task, {
            ...
            return `状态：${statusText}（${enabledText}）。${providerText} · ${mediaText}《${titleText}》保存到 ${savepath}${fixedShareText}${shareScopeText}${providerRuleText}${excludeText}${excludeFileText}${sizeFilterText}${strictMatchText}，${modeText}${startEpisodeText}，${episodeText}；${scheduleText}；${latestText}。`;
        }
